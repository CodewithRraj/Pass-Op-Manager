...
const Manager = () => {
    ...
    const showPassword = () => {
        ...
        if(ref.current.src.includes("icons/icon-eye-cross.png")){
            ref.current.src ="icons/icon-eye.png";
            passwordRef.current.type = "password"
    }
        else{
            ref.current.src ="icons/icon-eye-cross.png";
            passwordRef.current.type = "text"
    ...
    const deletePassword = (id) => {
      toast('Password Deleted', {
        ...
        console.log("deleting passwords by id"+id) 
    ...
    const editPassword = (id) => {
        console.log("Editing passwords by id"+id)
  ...
  return (
    ...
    <div className="flex flex-col p-4 text-black gap-5 items-center">
        ...
        <div className="flex flex-col md:flex-row w-full justify-between gap-8 ">
            ...
            <span className='absolute right-[188px] md:top-[228px] cursor-pointer'onClick={showPassword}>
                <img ref={ref} className= 'p-1'  width={31}  src="icons/icon-eye.png" alt="eye" />
            </span>
            </div>
        </div>
        <button onClick={savePassword} className='flex justify-center items-center bg-green-400 rounded-full gap-2 px-4 py-2 w-fit hover:bg-green-300 border border-green-900'>
            <lord-icon
    ...
    <div className="password">
        ...
        {passwordArray.length != 0 &&<table className="table-auto w-full rounded-md overflow-hidden mb-24">
  ...
  <tbody className='bg-green-100 '>
    {passwordArray.map((item,index)=>{
      ...
      <lord-icon
        style={{"width":"20px","height":"18px" , "paddingTop": "5px" , "paddingLeft": "3px"}}
      ...
      <td className=' items-center justify-center py-2 border border-white text-center min-w-32 '>
